...
echo -e '// Code generated by "go generate github.com/wailovet/goincv/third/gonum.org/v1/gonum/blas/gonum”; DO NOT EDIT.\n' > level1float32.go
...
| sed -e "s_^\(func (Implementation) \)D\(.*\)\$_$WARNINGF32\1S\2_" \
      ...
      -e 's_^// Id_// Is_' \
      -e 's_"github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/asm/f64"_"github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/asm/f32"_' \
      -e 's_"math"_math "github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/math32"_' \
...
| sed -e "s_^\(func (Implementation) \)Zdot\(.*\)\$_$WARNINGC64\1Cdot\2_" \
      ...
      -e 's_^// Dz_// Sc_' \
      -e 's_"github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/asm/c128"_"github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/asm/c64"_' \
      -e 's_"math"_math "github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/math32"_' \
>> level1cmplx64.go
...
| sed -e "s_^\(func (Implementation) \)Z\(.*\)\$_$WARNINGC64\1C\2_" \
      -e 's_^// Z_// C_' \
      -e 's_"github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/asm/c128"_"github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/asm/c64"_' \
      -e 's_"math/cmplx"_cmplx "github.com/wailovet/goincv/third/gonum.org/v1/gonum/internal/cmplx64"_' \
>> level2cmplx64.go
